 ...
 *
 */
public abstract class InvocationHandler<T> implements Handler<RoutingContext> {
	...
	protected Object[] getParameters(RoutingContext routingContext) throws Exception {
		...
		for (Parameter param : parameters) {
			Object paramInstance = getParameterInstance(routingContext, param.getAnnotations(), param.getType(),
					param.getName());
